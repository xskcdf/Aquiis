...
using WorkflowLeaseStatus = Aquiis.SimpleStart.Application.Services.Workflows.LeaseStatus;
...
public class LeaseWorkflowServiceTests
{
    ...
    private static async Task<TestContext> CreateTestContextAsync()
    {
        ...
        var workflowService = new LeaseWorkflowService(context, userContext, noteService);
