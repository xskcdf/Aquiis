...
using Aquiis.Professional.Shared.Authorization;
...
using (var scope = app.Services.CreateScope())
{
    ...
    var identityContext = scope.ServiceProvider.GetRequiredService<ProfessionalDbContext>();
...
app.MapStaticAssets();
app.MapRazorComponents<Aquiis.Professional.Shared.App>()
