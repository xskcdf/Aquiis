    ...
    public partial class ChecklistTemplateItemEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            var categorySection = runtimeEntityType.AddProperty(
                ...
                fieldInfo: typeof(ChecklistTemplateItem).GetField("<CategorySection>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                nullable: true,
                maxLength: 100);
            ...
            var checklistTemplateId = runtimeEntityType.AddProperty(
                ...
                fieldInfo: typeof(ChecklistTemplateItem).GetField("<ChecklistTemplateId>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                sentinel: new Guid("00000000-0000-0000-0000-000000000000"));
            ...
            var isRequired = runtimeEntityType.AddProperty(
                ...
                fieldInfo: typeof(ChecklistTemplateItem).GetField("<IsRequired>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                sentinel: false);
            ...
            var itemOrder = runtimeEntityType.AddProperty(
                ...
                fieldInfo: typeof(ChecklistTemplateItem).GetField("<ItemOrder>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                sentinel: 0);
            ...
            var itemText = runtimeEntityType.AddProperty(
                ...
                fieldInfo: typeof(ChecklistTemplateItem).GetField("<ItemText>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                maxLength: 500);
            ...
            var requiresValue = runtimeEntityType.AddProperty(
                ...
                fieldInfo: typeof(ChecklistTemplateItem).GetField("<RequiresValue>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                sentinel: false);
            ...
            var sectionOrder = runtimeEntityType.AddProperty(
                ...
                fieldInfo: typeof(ChecklistTemplateItem).GetField("<SectionOrder>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                sentinel: 0);
        ...
        public static RuntimeForeignKey CreateForeignKey1(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
        {
            ...
            var checklistTemplate = declaringEntityType.AddNavigation("ChecklistTemplate",
                ...
                fieldInfo: typeof(ChecklistTemplateItem).GetField("<ChecklistTemplate>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));

            var items = principalEntityType.AddNavigation("Items",
                runtimeForeignKey,
                onDependent: false,
                typeof(ICollection<ChecklistTemplateItem>),
                ...
                fieldInfo: typeof(ChecklistTemplate).GetField("<Items>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
